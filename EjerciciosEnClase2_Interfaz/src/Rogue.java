...
public class Rogue extends BaseCharacter{
    ...
    public Rogue(String name, int level) {
        ...
        this.weapon = "Dual Knife";
        this.hp = 300 * getLevel();
        this.mana = 10 * getLevel();
        this.attackDamage = 10 * getLevel();
        this.armor = 9 * getLevel();
        this.agility = 20 * getLevel();
    }
