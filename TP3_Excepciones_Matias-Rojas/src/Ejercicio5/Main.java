...
public class Main {
    public static void main(String[] args) {
        ...
        while (active) {
            ...
            try {
                ...
                switch (option) {
                    case 1:
                        ...
                        } catch (Exceptions.InvalidPriority e) {
            ...
            } catch (Ejercicio5.Exceptions.InvalidOption e){
                System.out.println(e.getMessage());
            }
        }
    }
    public static void validatePriority(int priority) throws Ejercicio5.Exceptions.InvalidPriority{
        if (priority < 1 || priority > 100){
            throw new Ejercicio5.Exceptions.InvalidPriority("Prioridad inválida. Ingrese una prioridad del 1 al 100."+"\n");
        }
    }
    public static void validateOption(int option) throws Ejercicio5.Exceptions.InvalidOption{
        if (option < 0 || option > 4){
            throw new Ejercicio5.Exceptions.InvalidOption("Opción inválida."+"\n");
        }
    }
}